...
function write_table() # non utilise 
...
#    $sql_5 = "INSERT INTO the last web_commande (CODE_WEB) VALUES ('$iod')";
    $sql = "INSERT INTO web_commande (CODE_WEB, LIV, ADR1, ADR2, CP, VILLE, PAYS, DATECDE, PORT, MODE_DE_REGLEMENT, NOTA, TRAITE) VALUES ('$id_od', '$id_ca', '$id_a1', '$id_a2', '$id_po', '$id_cy', '$id_co', '$id_da', '$id_ts', '$id_pa', '$id_ea', '$id_st')"; 
