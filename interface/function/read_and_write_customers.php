     ...
     # debut boucle verif 
        ...
        $id_checked = $result[0];
            ...
            echo '</br>';
                ...
                echo "ID Presta existante alors voir aussi web_client de Kezia ";
                echo '</br>';
...
try {
   ...
   WEB_CLIENT (
   -- CODE_WEB,
    NOMCLI, ADR1, ADR2, CP, VILLE, PAYS, TELPERSO, GSM, EMAIL, DATECREATION, TRAITE
   )
   VALUES (
   -- '$id_od',
   '$id_ln',
